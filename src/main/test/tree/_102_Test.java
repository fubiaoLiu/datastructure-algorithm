...
public class _102_Test {
    ...
    public void should_return_empty_given_tree0(){
        ...
        assertThat(levelOrder.levelOrder(TreeNodeUtil.tree0()).size()).isEqualTo(0);
    }
    @Test
    public void should_return_1_given_tree1(){
        _102_二叉树的层次遍历 levelOrder = new _102_二叉树的层次遍历();
        assertThat(levelOrder.levelOrder(TreeNodeUtil.tree1()).size()).isEqualTo(1);
        assertThat(levelOrder.levelOrder(TreeNodeUtil.tree1()).get(0).size()).isEqualTo(1);
    }
    @Test
    public void should_return_1_23_4_5_given_tree5(){
        _102_二叉树的层次遍历 levelOrder = new _102_二叉树的层次遍历();
        List<List<Integer>> list = levelOrder.levelOrder(TreeNodeUtil.tree5());
