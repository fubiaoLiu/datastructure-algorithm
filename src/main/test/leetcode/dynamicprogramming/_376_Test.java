...
public class _376_Test {
    _376_摆动序列 obj = new _376_摆动序列();

    @Test
    public void test1() {
        int[] nums = {1, 7, 4, 9, 2, 5};
        assertEquals(6, obj.wiggleMaxLength(nums));
    }

    @Test
    public void test2() {
        int[] nums = {1, 17, 5, 10, 13, 15, 10, 5, 16, 8};
        assertEquals(7, obj.wiggleMaxLength(nums));
    }

    @Test
    public void test3() {
        int[] nums = {1, 2, 3, 4, 5, 6, 7, 8, 9};
        assertEquals(2, obj.wiggleMaxLength(nums));
    }
    ...
    public void test4() {
        ...
        assertEquals(67, obj.wiggleMaxLength(nums));
    }
}