...
public class AVLTreeTest {
    ...
    public void test_preorder() {
        ...
        bst.preorder(new AVLTree.Visitor<Integer>() {
            @Override
    ...
    public void test_inorder() {
        ...
        bst.inorder(new AVLTree.Visitor<Integer>() {
            @Override
            public boolean visit(Integer element) {
                System.out.print("[" + element + "]");
                return false;
    ...
    public void test_postorder() {
        ...
        bst.postorder(new AVLTree.Visitor<Integer>() {
            @Override
            public boolean visit(Integer element) {
                System.out.print("[" + element + "]");
                return false;
    ...
    public void test_levelOrder() {
        ...
        bst.levelOrder(new AVLTree.Visitor<Integer>() {
            @Override
            public boolean visit(Integer element) {
                System.out.print("[" + element + "]");
                return false;
    ...
    public void test_comparator() {
        AVLTree<Person> bst = new AVLTree<>(new PersonComparator());
        ...
        bst.inorder(new AVLTree.Visitor<Person>() {
            @Override
